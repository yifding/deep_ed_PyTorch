...
class UnicodeMap(object):
    ...
    @property
    def dict(self):
        return self.byte2chr

    def preprocess(self):
        assert len(self.utf8_byte) == len(self.utf8_chr)
        for b, c in zip(self.utf8_byte, self.utf8_chr):
            # assert utf8_to_str_1(b) == utf8_to_str_2(b)
            self.num_list.append(int(b[2:], base=16))
            if utf8_to_str_1(b) != c:
                print(b,repr(utf8_to_str_1(b)), repr(c))
            self.byte2chr[b] = c
        ...
        self.num_list.append(int('\\u0022'[2:], base=16))
        self.num_list.append(int('\\u0023'[2:], base=16))
        self.num_list.append(int('\\u005c'[2:], base=16))
        self.num_list.append(int('\\u00a0'[2:], base=16))

        print("number of byte2chr:", len(self.num_list))
        # print(sorted(self.num_list))
